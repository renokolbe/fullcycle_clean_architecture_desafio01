...
## Configuracoes node
## RK ## RUN npm i typescript --save-dev
##RUN npx tsc --init
## RK ## RUN npm i tslint --save-dev
##RUN npx tslint --init
##RUN npm install tslint-config-airbnb ## nao precisa
## RK ## RUN npm i -D jest @types/jest ts-node --save-dev
## RK ## RUN npm i -D @swc/jest @swc/cli @swc/core
##RUN npx jest --init
## RK ## RUN npm i uuid @types/uuid --save-dev
## RK ## RUN npm install sequelize reflect-metadata sequelize-typescript 
## RK ## RUN npm install sqlite3 
